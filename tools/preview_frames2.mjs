 ...
 *    node tools/preview_frames2.mjs 20 900 1800 3200
 *  加 --page 就改成截互動頁（web/index.html），順便把 console 錯誤印出來。
 *    node tools/preview_frames2.mjs --page
 */
...
const OUT = path.join(ROOT, "out", "preview2");
...
if (pageMode) {
  ...
  await page.goto("http://localhost:8051/web/record2.html", { waitUntil: "networkidle0" });
